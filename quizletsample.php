<?php
// Your credentials
$myClientId = 'fFCBWXYZSc';
$mySecret = 'QSMAMrrOOMaI0h.LS8axpQ';
$myUrl = 'http://demo.poodll.com/filter/poodll/quizlet.php';
...
if (empty($_GET['code']) && empty($_GET['error'])) {
    ...
    echo '<a href="'.$authorizeUrl.'&state='.$_SESSION['state'].'&redirect_uri='.$myUrl.'">Step 1: Start Authorization</a>';
    exit();
}
